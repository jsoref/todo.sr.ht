...
type ComplexityRoot struct {
	...
	Label struct {
		...
		Tickets         func(childComplexity int, cursor *string) int
		Tracker         func(childComplexity int) int
	}
	...
	Query struct {
		Events         func(childComplexity int, cursor *string) int
		Me             func(childComplexity int) int
		Subscriptions  func(childComplexity int, cursor *string) int
		...
		Trackers       func(childComplexity int, cursor *string) int
	...
	Tracker struct {
		Acls        func(childComplexity int, cursor *string) int
		Created     func(childComplexity int) int
		DefaultACLs func(childComplexity int) int
		Description func(childComplexity int) int
		ID          func(childComplexity int) int
		Labels      func(childComplexity int, cursor *string) int
		Name        func(childComplexity int) int
...
type QueryResolver interface {
	...
	Trackers(ctx context.Context, cursor *string) (*model.TrackerCursor, error)
	...
	Events(ctx context.Context, cursor *string) (*model.EventCursor, error)
	Subscriptions(ctx context.Context, cursor *string) (*model.SubscriptionCursor, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Label.tickets":
		...
		return e.complexity.Label.Tickets(childComplexity, args["cursor"].(*string)), true
	...
	case "Query.events":
		...
		return e.complexity.Query.Events(childComplexity, args["cursor"].(*string)), true
	...
	case "Query.subscriptions":
		...
		return e.complexity.Query.Subscriptions(childComplexity, args["cursor"].(*string)), true
	...
	case "Query.trackers":
		...
		return e.complexity.Query.Trackers(childComplexity, args["cursor"].(*string)), true
	...
	case "Tracker.acls":
		...
		return e.complexity.Tracker.Acls(childComplexity, args["cursor"].(*string)), true
	...
	case "Tracker.labels":
		...
		return e.complexity.Tracker.Labels(childComplexity, args["cursor"].(*string)), true
	...
	case "Tracker.tickets":
		...
		return e.complexity.Tracker.Tickets(childComplexity, args["cursor"].(*string)), true
	...
	case "User.trackers":
		...
		return e.complexity.User.Trackers(childComplexity, args["cursor"].(*string)), true
...
func (ec *executionContext) _Query_trackers(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Query().Trackers(rctx, args["cursor"].(*string))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			scope, err := ec.unmarshalNAccessScope2gitᚗsrᚗhtᚋאsircmpwnᚋtodoᚗsrᚗhtᚋapiᚋgraphᚋmodelᚐAccessScope(ctx, "TRACKERS")
			if err != nil {
...
func (ec *executionContext) _Query_events(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Query().Events(rctx, args["cursor"].(*string))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
...
func (ec *executionContext) _Query_subscriptions(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Query().Subscriptions(rctx, args["cursor"].(*string))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
...
func (ec *executionContext) _Comment(ctx context.Context, sel ast.SelectionSet, obj *model.Comment) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "authenticity":
			out.Values[i] = ec._Comment_authenticity(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "superceededBy":
			out.Values[i] = ec._Comment_superceededBy(ctx, field, obj)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
func (ec *executionContext) _Event(ctx context.Context, sel ast.SelectionSet, obj *model.Event) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "tracker":
			out.Values[i] = ec._Event_tracker(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
